...
<svg width="40" height="40" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    <rect x="0" y="0" width="40" height="40" style="fill: <?php echo $bg_color; ?>"></rect>
    <text x="50%" y="50%" dy=".1em" fill="#000000" text-anchor="middle" dominant-baseline="middle" style="font-family:sans-serif; font-size: 20; line-height: 1"><?php echo htmlentities($initials); ?></text>
</svg>